...
class BreadcrumbsClass extends HTML {
   ...
   make_links(){
      ...
      if (meta.__DOCTYPE__.module) {
         const text = Capitalize(this.context === 'module' ? 'Home' : meta.__DOCTYPE__.module);
      ...
      if (meta.__DOCTYPE__.name && this.context !== 'module' && !meta.__DOCTYPE__.is_single) {
         data_links.push({text: Capitalize(meta.__DOCTYPE__.name), link: `/${meta.__DOCTYPE__.module}/${meta.__DOCTYPE__.name}/list`, has_icon: false});
      }
